...
class NetworkFirewallPoliciesClient {
    ...
    addPacketMirroringRule(request, optionsOrCallback, callback) {
        ...
        this.initialize();
        return this.innerApiCalls
            .addPacketMirroringRule(request, options, callback)
            .then(([response, operation, rawResponse]) => {
            return [
                {
                    latestResponse: response,
    ...
    getPacketMirroringRule(request, optionsOrCallback, callback) {
        ...
        this.initialize();
        return this.innerApiCalls.getPacketMirroringRule(request, options, callback);
    }
    ...
    patchPacketMirroringRule(request, optionsOrCallback, callback) {
        ...
        this.initialize();
        return this.innerApiCalls
            .patchPacketMirroringRule(request, options, callback)
            .then(([response, operation, rawResponse]) => {
            return [
                {
                    latestResponse: response,
    ...
    removePacketMirroringRule(request, optionsOrCallback, callback) {
        ...
        this.initialize();
        return this.innerApiCalls
            .removePacketMirroringRule(request, options, callback)
            .then(([response, operation, rawResponse]) => {
            return [
                {
                    latestResponse: response,
